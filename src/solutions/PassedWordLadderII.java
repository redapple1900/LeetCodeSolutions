...
public class PassedWordLadderII {
		 ...
		 * cog => dot -- log
		 */
		public ArrayList<ArrayList<String>> findLadders(String start, String end, Set<String> set) {
		    ...
		    Set<String> unVisited = new HashSet<String>(set);                  //unvisited words
